...
public class TrelloFacadeTest {
    ...
    @BeforeEach
    void setupTests() {
        trelloLists = List.of(new TrelloListDto("1", "test_list", false));
        trelloBoards = List.of(new TrelloBoardDto("test", "1", trelloLists));
        mappedTrelloLists = List.of(new TrelloList("1", "test_list", false));
        mappedTrelloBoards = List.of(new TrelloBoard("1", "test", mappedTrelloLists));
    }
